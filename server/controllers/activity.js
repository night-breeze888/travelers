...
activity.everyDay_list = async function (ctx) {
...
activity.everyDay_award = async function (ctx) {

    let { session, knex, request: { body }, params ,utils ,eos} = ctx
    // if(!session.system_auth){
    //     ctx.body = {
    //         code: 400, msg:'not jurisdiction'
    //     }
...
activity.time_put = async function (ctx) {
...
activity.time_delete = async function (ctx) {
...
activity.activity_choice = async function (ctx) {
